...
const (
	...
	// ClusterValidationIDNetworkValid captures enum value "network-valid"
	ClusterValidationIDNetworkValid ClusterValidationID = "network-valid"
)
...
func init() {
	...
	if err := json.Unmarshal([]byte(`["machine-cidr-defined","cluster-cidr-defined","service-cidr-defined","no-cidrs-overlapping","network-prefix-valid","machine-cidr-equals-to-calculated-cidr","api-vip-defined","api-vip-valid","ingress-vip-defined","ingress-vip-valid","all-hosts-are-ready-to-install","sufficient-masters-count","dns-domain-defined","pull-secret-set","ntp-server-configured","lso-requirements-satisfied","ocs-requirements-satisfied","cnv-requirements-satisfied","network-valid"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
